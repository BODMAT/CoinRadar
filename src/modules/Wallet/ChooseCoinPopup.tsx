...
export function ChooseCoinPopup() {
    ...
    return (
        <div>
            <div className="w-full rounded transitioned bg-[var(--color-card)] mb-3">
                <input
                    value={inputValue}
                    onChange={e => setInputValue(e.target.value)}
                    type="text"
                    placeholder="Find coin..."
                    className="w-full bg-transparent px-2 py-4 outline-none text-white border-[var:--color-text] placeholder-white/50"
                />
            </div>
