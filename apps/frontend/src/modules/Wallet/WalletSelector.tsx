...
export function WalletSelector() {
  const { walletsList, selectedWalletId } = useAppSelector(
  ...
  return (
    <div className="p-4 flex items-center gap-4 min-w-[200px] max-[900px]:flex-col">
      <label className="block text-2xl font-medium">Choose a wallet:</label>
      <Select
        options={options}
