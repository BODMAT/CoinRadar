...
import {
  blockFromLeftAnimation,
  blockFromRightAnimation,
  ...
  return (
    ...
    >
      <div className="flex-3/5 max-lg:flex-1">
        ...
        <motion.button
          onClick={handleOnenPopup}
          custom={0.5}
          variants={blockFromLeftAnimation}
          className="transitioned relative p-4 rounded-2xl bg-[var-(--color-card)] text-white 
      ...
      <motion.div
        variants={blockFromRightAnimation}
        className="w-full flex-2/5"
      >
