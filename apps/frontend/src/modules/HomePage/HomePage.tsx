    ...
    return (
        <motion.div
            ...
            <div className="flex-3/5 max-lg:flex-1">
                ...
                <motion.button onClick={handleOnenPopup} custom={4} variants={blockFromLeftAnimation} className="transitioned relative p-4 rounded-2xl bg-[var-(--color-card)] text-white 
