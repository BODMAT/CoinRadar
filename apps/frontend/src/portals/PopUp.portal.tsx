            ...
            {active && (
                ...
                >
                    <motion.div
                        ...
                        className={"fontText bg-(--color-card) text-(--color-text) backdrop-blur-md rounded-lg w-[90%] max-w-[700px] shadow-lg relative z-999999! max-md:mt-[5vh] max-h-[80vh] flex flex-col overflow-hidden " + (withoutSizes ? "" : "")}
                    >
